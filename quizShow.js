...
$(document).ready(function(){
    ...
    quizEngine.score = 0;
    quizEngine.questionBox = $('#question');
    ...
    quizEngine.print_question = function () {
        ...
        quizEngine.questionBox.html("<p>" + currentQuestion + "</p>");
};
    ...
    quizEngine.print_answers = function () {
        ...
        choice.forEach(function (e) {
            ...
            /*var currentChoices = '<input type="radio" name="currentAnswer" class="radioAnswer" value="' + e + '">' + '<label for="'+e+'">'+e+'</label><br>';

            quizEngine.answersBox.append(currentChoices);*/
    ...
    quizEngine.clear_question = function () {
        quizEngine.questionBox.children().remove();
